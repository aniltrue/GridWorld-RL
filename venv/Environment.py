...
class Environment:
    def __init__(self, grid_file):
        ...
        object which inclued the grid and the start position. Grid is a 2d String list and start position
    ...
    def move(self, action):
        """
        This function gets your action as input and checks wheather your action is vertical or
